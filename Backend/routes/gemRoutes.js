...
const { createGem, getGems, likeGem, deleteGem, updateGem, getSingleGem, searchGems, getTrendingGems, getUserGems } = require("../controllers/gemController");
...
router.get("/user/:id", protect, getUserGems);
